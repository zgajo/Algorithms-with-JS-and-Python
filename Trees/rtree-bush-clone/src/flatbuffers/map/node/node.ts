...
static createNode(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, lat:number, lon:number, partOfWaysOffset:flatbuffers.Offset, pointsToOffset:flatbuffers.Offset, distanceOffset:flatbuffers.Offset):flatbuffers.Offset {
  Node.startNode(builder);
  Node.addId(builder, idOffset);
  Node.addLat(builder, lat);
  Node.addLon(builder, lon);
  Node.addPartOfWays(builder, partOfWaysOffset);
  Node.addPointsTo(builder, pointsToOffset);
  Node.addDistance(builder, distanceOffset);
