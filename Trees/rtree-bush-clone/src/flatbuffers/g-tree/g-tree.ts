...
import { GTreeBox } from '../g-tree/g-tree-box';
...
static finishGTreeBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset);
}

static finishSizePrefixedGTreeBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
